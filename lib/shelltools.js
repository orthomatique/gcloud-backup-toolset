...
function mostRecentFile(dirpath) {
    var files =  fs.readdirSync(dirpath).map(function(file){
...
function getHumanReadableFileSize(filepath) {
    ...
    if (stat) {
        var size = stat.size;
        var kbytes = Math.floor(size / 1024);
        var mbytes = Math.floor(size / (1024 * 1024));
        var gbytes = Math.floor(size / (1024 * 1024 * 1024));

        if (size > (1024*1024*1024)) {
            return parseFloat(Math.ceil(size / (1024 * 1024 * 1024) * 100)/100).toFixed(2) + "GB";
        } else if (size > (1024*1024)) {
            return parseFloat(Math.ceil(size / (1024 * 1024) * 100)/100).toFixed(2) + "MB";
        } if (size > (1024)) {
            return parseFloat(Math.ceil(size / 1024 * 100)/100).toFixed(2) + "KB";
        } else {
...
exports.mostRecentFile = mostRecentFile;
